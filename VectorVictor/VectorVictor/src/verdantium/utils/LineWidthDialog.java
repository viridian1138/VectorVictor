...
public class LineWidthDialog {
	...
	// display a dialog for setting the line width
	   public void showLineWidthDialog( Activity activity )
	   {
	      ...
	      currentDialog.setContentView( com.postgreen.vectorvictor.R.layout.width_dialog);
	      currentDialog.setTitle( com.postgreen.vectorvictor.R.string.title_line_width_dialog );
	      currentDialog.setCancelable(true);
	      
	      // get widthSeekBar and configure it
	      SeekBar widthSeekBar = 
	         (SeekBar) currentDialog.findViewById( com.postgreen.vectorvictor.R.id.widthSeekBar);
	      ...
	      Button setLineWidthButton = 
	         (Button) currentDialog.findViewById( com.postgreen.vectorvictor.R.id.widthDialogDoneButton);
	      ...
	      new OnSeekBarChangeListener() 
	      {
	         ...
	         {  
	            ...
	            LineWidthView lineWidthView = (LineWidthView) 
	               currentDialog.findViewById( com.postgreen.vectorvictor.R.id.lineWidthView);
