...
public class SymListNode extends Meta<SymListNode> implements Externalizable {
	...
	* Returns the symbol.
	*/
	public FlexString getSymbol() {
		return (Symbol);
	}
	/**
	* Returns the tag.
	*/
	public FlexString getTag() {
		return (tag);
	}
	/**
	* Sets the symbol.
	*/
	public void setSymbol(FlexString in) {
		Symbol = in;
	}
	...
	*/
	public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
		try {
			...
			tag = (FlexString) (myv.getProperty("tag"));
			VersionBuffer.chkNul(tag);
			Symbol = (FlexString) (myv.getProperty("Symbol"));
			VersionBuffer.chkNul(Symbol);
			MathImage.chkParse(Symbol, MathImage.UserMode);
		}
	...
	*/
	public void writeExternal(ObjectOutput out) throws IOException {
		...
		myv.setProperty("tag", tag);
		myv.setProperty("Symbol", Symbol);

		out.writeObject(myv);
	}

	private FlexString tag = new FlexString();
	private FlexString Symbol = new FlexString();
