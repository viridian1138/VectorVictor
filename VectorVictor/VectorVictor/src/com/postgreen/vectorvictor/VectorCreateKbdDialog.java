...
public class VectorCreateKbdDialog {
	
	
	private VectorVictorActivity activity;
	private GeoPadKit FreeKit;
	private GeoPadPanel pn;
	
	
	public VectorCreateKbdDialog( VectorVictorActivity _activity , GeoPadKit _FreeKit , GeoPadPanel _pn )
	{
		activity = _activity;
		FreeKit = _FreeKit;
		pn = _pn;
    ...
    public void showVectorCreateKbdDialog( )
	{
		try
 		{
			activity.playClick();
...
protected void addCreateKeyboardListeners( Dialog dialog )
{
	...
	final OnClickListener delSymListener = new OnClickListener()
	{
		public void onClick(final View arg0) {
			...
			dialog.showSymbolDeleteDialog( activity );
		}
	};
