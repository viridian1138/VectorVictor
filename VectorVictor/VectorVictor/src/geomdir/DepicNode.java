...
/* This is strictly a record type.  Hence object common law does not apply. */

/**
* This is a record class that stores information about how to create
* a particular kind of depictor, and what icon to use to represent it on
* a palette.
* @author Thorn Green
*/
public class DepicNode extends Meta<DepicNode> {
	...
	* label does not represent a user variable in the same way that
	* a vector or a phasor does, and thus "self names" because it doesn't
