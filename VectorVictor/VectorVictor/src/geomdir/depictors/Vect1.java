...
*/
public class Vect1 extends DrawObj implements Externalizable {
	...
	public void datCpy(Vect1 out) {
		drDatCpy(out);
		/* out.HdPoint = HdPoint;
		out.TlPoint = TlPoint; */
	};
	public Meta copyNode() {
		Vect1 temp = new Vect1();
		datCpy(temp);
		return (temp);
	};
	public Meta copySub() {
	...
	*/
	...
	static transient Vect1 UndoNode = null;
...
/*	public void saveProperties(DepictorPort ThePort, VTextProperties MyProp) {
	...
	*/
	...
	public static URL getUpImgUrl() {
		return (getDefaultUpImgUrl(Vect1.class));
	}
