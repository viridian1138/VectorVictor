...
*/
public class Angle2 extends DrawObj implements Externalizable {
	...
	*/
	protected void drawPolarSegment(DepictorPort ThePort, DefContext Dcon, boolean bound, Canvas g, Paint p, int ToolMode) {
	...
	*/
	...
	public static URL getUpImgUrl() {
		return (getDefaultUpImgUrl(Angle2.class));
	}
...
//		return ((new Angle2CustControl(this, ThePort, InAp)));
//	};
	...
	*/
/*	public static class Angle2CustControl extends Object implements VerdantiumPropertiesEditor {
		Angle2 target;
		DepictorPort ThePort;
		...
		public Angle2CustControl(Angle2 in, ToolPort port, XKit MyAp) {
			super();
			target = in;
			ThePort = port;
			MyPan = new JPanel();
