...
/**
* This is a "record" class used by several depictors to store
* information about which control's gravity field a mouse event touched.
* A depictor class does not have to use this class.  Any subclass of
* {@link geomdir.ClickRec} will do.  The main reason multiple depictors use this
...
* at this time.
*/
public class APPRec<Z extends Object, T extends APPRec<Z,T,?>, Q extends CoordContext> extends ClickRec<T> {

	public Z getValue() {
		return (value);
	}
	public void setValue(Z in) {
		value = in;
	}
	public PointF getAngPoint() {
		return (angPoint);
	}
	public Mvec getTransDelta() {
		return (transDelta);
	}
	public Mvec getTransDelta2() {
		return (transDelta2);
	}
	...
	private Z value;
	private final PointF angPoint = new PointF();
