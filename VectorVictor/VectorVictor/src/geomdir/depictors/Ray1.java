...
/**
* Depicts a ray in the standard sense using the vector-valued part of a multivector.
* The line is an infinite object starting at one point and going through another.  The first is
* defined by the "_hd_" port.  The second is the "_hd_" port plus the "vector port".
...
*/
public class Ray1 extends Vect1 {
	/**
	...
	*/
	public double shapeGravityField(PointF p1, PointF p2, PointF in) {
		return (linearRayGravityField(p1, p2, in, getBasicFrontLineStrokeWidth()));
	}

	public static URL getUpImgUrl() {
		return (getDefaultUpImgUrl(Ray1.class));
	}
