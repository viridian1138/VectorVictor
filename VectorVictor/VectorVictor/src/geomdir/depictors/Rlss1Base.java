...
public abstract class Rlss1Base<T extends Rlss1Base, Q extends Rlss1Base.RlssContext, R extends APPRec<?,Q>> extends DrawObj<T,Q,R> implements Externalizable {
	...
	public static class RlssContextImpl extends RlssContext<RlssContextImpl>
	{
		public RlssContextImpl(int inMaxGrad) {
			super(inMaxGrad);
		}
		
		@Override
		public RlssContextImpl makeMeta() {
			return( new RlssContextImpl( this.getMaxGraduations() ) );
		}
	...
	*/
	...
	static Rlss1Base UndoNode = null;
...
//	};
	...
	*/
	...
	//		{ Rlss1BaseHelp.run( in ); }

	public static URL getUpImgUrl() {
		return (getDefaultUpImgUrl(Rlss1Base.class));
	} /* !!!!!!!!!!!!!!!!!!!!!! */
