...
*/
public class Compar1 extends DrawObj implements Externalizable {
	...
	public void datCpy(Compar1 out) {
		drDatCpy(out);
		/* out.MdPoint = MdPoint;
		out.HdPoint = HdPoint;
		out.TlPoint = TlPoint; */
	...
	*/
	...
	public static URL getUpImgUrl() {
		return (getDefaultUpImgUrl(Compar1.class));
	}
