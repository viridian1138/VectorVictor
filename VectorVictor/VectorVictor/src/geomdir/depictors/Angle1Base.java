...
public abstract class Angle1Base<T extends Angle1Base, Q extends DefContext, R extends APPRec<?,Q>> extends DrawObj<T,Q,R> implements Externalizable {
	...
	*/
	...
	static Angle1Base UndoNode = null;
	...
	*/
	...
	public static URL getUpImgUrl() {
		return (getDefaultUpImgUrl(Angle1Base.class));
	}
...
//		return ((new Angle1BaseCustControl(this, ThePort, InAp)));
//	};
	...
	*/
/*	public static class Angle1BaseCustControl extends Object implements VerdantiumPropertiesEditor {
		Angle1Base target;
		DepictorPort ThePort;
		...
		public Angle1BaseCustControl(Angle1Base in, ToolPort port, XKit MyAp) {
			super();
			target = in;
			ThePort = port;
			MyPan = new JPanel();
