...
*/
public class Ssca1 extends DrawObj implements Externalizable {
	...
	public void datCpy(Ssca1 out) {
		drDatCpy(out);
		/* out.HdPoint = HdPoint;
		out.TlPoint = TlPoint; */
	};
	public Meta copyNode() {
		Ssca1 temp = new Ssca1();
		datCpy(temp);
		return (temp);
	};
	public Meta copySub() {
	...
	*/
	private final void delVarTypeA(DepictorPort ThePort, ClickRec in, FlexString CurString) {
		...
		if (MyRec.getValue() == ManualDragVectCp) {
...
/*		if (in instanceof DrawObjEtherEvent) {
	...
	*/
	...
	public Hexar uLGetHex(DefContext in) {
		return (in.getHex4());
	};
...
//	};
	...
	public static URL getUpImgUrl() {
		return (getDefaultUpImgUrl(Ssca1.class));
	}
