...
* {@link Vect1}.
*/
public class Direc1 extends Vect1 implements Externalizable {
	...
	*/
	public void pushDragUndo() {
		...
		((Direc1) UndoNode).Directionals = Directionals;
	}
	...
	*/
	public void popDragUndo() {
		...
		Directionals = ((Direc1) UndoNode).Directionals;
		((Direc1) UndoNode).Directionals = TmpDirec;
	}

	public Meta copyUser1() {
		Direc1 temp = new Direc1();
...
//	}
	...
	public static URL getUpImgUrl() {
		return (getDefaultUpImgUrl(Direc1.class));
	}
