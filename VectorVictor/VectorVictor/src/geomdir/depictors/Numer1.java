...
*/
public class Numer1 extends DrawObj implements Externalizable {
	...
	public void datCpy(Numer1 out) {
		drDatCpy(out);
		/* out.HdPoint = HdPoint;
		out.TlPoint = TlPoint; */
	};
	public Meta copyNode() {
		Numer1 temp = new Numer1();
		datCpy(temp);
		return (temp);
	};
	public Meta copySub() {
...
//	};
	...
	public static URL getUpImgUrl() {
		return (getDefaultUpImgUrl(Numer1.class));
	}
...
/*	public static class NumerCustControl extends Object implements VerdantiumPropertiesEditor {
		...
		public NumerCustControl(Numer1 in, ToolPort port, XKit MyAp) {
			super();
			target = in;
			ThePort = port;
			MyPan = new JPanel();
