...
/**
* Depicts the imaginary-valued part of a multivector as a triangular area.
...
*/
public class Tria1 extends DrawObj implements Externalizable {
	...
	*/
	public void updateYourself(DepictorPort ThePort, CoordContext PrtCon, boolean bound, int ToolMode) {
		...
		u_del_vert.scale(2.0 * (getVect()).getBasis12() / (len), comp2);
...
/*	public void saveProperties(DepictorPort ThePort, VTextProperties MyProp) {
	...
	*/
	...
	public static URL getUpImgUrl() {
		return (getDefaultUpImgUrl(Tria1.class));
	}
