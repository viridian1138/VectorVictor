...
/**
* Depicts a line.
* The line is an infinite object going through two points.  The first is
...
*/
public abstract class Line1Base<T extends Line1Base, Q extends DefContext, R extends APPRec<Vect1Base.Vect1Evt,?,Q>> extends Vect1Base<T,Q,R> implements Externalizable {
	...
	*/
	...
	public static URL getUpImgUrl() {
		return (getDefaultUpImgUrl(Line1Base.class));
	}
