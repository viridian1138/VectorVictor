...
class RulerContext extends DefContext {
...
*/
public class Ruler1 extends Dsca1 implements Externalizable {
	...
	*/
	public void pushDragUndo() {
		...
		((Ruler1) UndoNode).HasNegative = HasNegative;
	}
	...
	*/
	public void popDragUndo() {
		...
		HasNegative = ((Ruler1) UndoNode).HasNegative;
		((Ruler1) UndoNode).HasNegative = TmpNegative;
	}
...
//	};
	...
	public CoordContext makeCoordContext() {
		return (new RulerContext(MajorGraduationLevel, MinorGraduationDelta));
	};
