...
/**
* Suite of Ether Event types that apply to Ktool instances.
* The idea is to make Ktool more powerful by allowing it to
* handle events.
* @author Thorn Green
*/
public class KtoolEtherEvent extends EtherEvent {

	public KtoolEtherEvent(Object source, String EtherID, Object param, Object tar) {
		super(source, EtherID, param, tar);
	}

	public KtoolEtherEvent(Object source, String EtherID, Object old_param, Object param, Object tar) {
