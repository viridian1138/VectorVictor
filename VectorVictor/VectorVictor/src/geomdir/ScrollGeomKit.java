...
/**
* A scrolling version of {@link GeomKit}.
*
* @author Thorn Green
*/
public class ScrollGeomKit extends GeomKit /* implements ScrollableAlt */ {

	/**
	* Constructor for ScrollGeomKit.  See the superclass definition.
	*/
	public ScrollGeomKit(Context context, String Configs, int InOriginType, TwoDScrollView _jsc ) {
		super(context, Configs, InOriginType);
		jsc = _jsc;
	}
	...
	* Constructor for ScrollGeomKit.  See the superclass definition.
	*/
	public ScrollGeomKit(Context context, TwoDScrollView _jsc) {
		super(context);
		jsc = _jsc;
	}
	...
	* Constructor for ScrollGeomKit.  See the superclass definition.
	*/
	public ScrollGeomKit(ScrollGeomKit in, TwoDScrollView _jsc) {
		super(in);
		jsc = _jsc;
	}
...
//	}
	...
	*/
	protected PointF getViewportPosition() {
		return ( new PointF( getScrollX() , getScrollY() ) );
	}
	...
	*/
	protected void resetViewPosition(IntObj XOrigin, IntObj YOrigin, Rect VisRect) {
		//jsc.scrollTo( VisRect.left , VisRect.top );
	}



	/**
	* Creates a geometry kit that is a view of the current one.
	*/
	public GeomKit createViewGeomKit(TwoDScrollView _jsc) {
		return (new ScrollGeomKit(this, _jsc));
	}
...
//		jsc.getViewport().invalidate();
//		jsc.getViewport().validate();
		// jsc.scrollTo( 1000 , 1000 );
	}
...
//		MyProp.putInt(key + ".XView", getViewportPosition().x);

//		MyProp.putInt(key + ".YView", getViewportPosition().y);
	}

	/**
	* Gets the viewport for the scroll pane.
	*/
//	public JViewport getViewport() {
//		return (jsc.getViewport());
//	}
