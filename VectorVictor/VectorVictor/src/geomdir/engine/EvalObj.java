...
public class EvalObj {
	/**
	* Constructs the EvalObj. Subclasses use a more complex constructor.
	*/
	public EvalObj() {}

	/**
	* Performs an evaluation and places the result in the result parameter.
	* Subclasses always override this method.
	*/
	public void eval(Mvec result) {
		System.out.println("Running superclass version.");
	}
}
