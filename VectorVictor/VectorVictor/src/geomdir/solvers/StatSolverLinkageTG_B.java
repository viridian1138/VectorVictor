...
*    | 10/20/2002            | Thorn Green (viridian_1138@yahoo.com)           | Improve constraint solving.                                          | Created StatSolverLinkageTG_B from StatSolverLinkage.
...
*/
public class StatSolverLinkageTG_B extends StatSolverLinkageBase {

	public StatSolverBase createStatSolver() {
		return (new StatSolverTG_B(this));
	}
