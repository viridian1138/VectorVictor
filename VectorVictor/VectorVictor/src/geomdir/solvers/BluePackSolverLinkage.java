...
*    | 10/14/2002            | Thorn Green (viridian_1138@yahoo.com)           | Looking for bug.                                                     | Instrumented BluePack to find the bug, then reversed the changes.
*    | 10/20/2002            | Thorn Green (viridian_1138@yahoo.com)           | BluePack linked to Herculaneum.                                      | Changed BluePack to fix this.
...
* 1990, pp. 54-63.
*/
public class BluePackSolverLinkage extends SolverLinkage {
	...
	*/
	...
	/**
	* Returns whether the last traversal was for a negation.
	*/
	public static boolean getLastTraverseNegate() {
		return (lastTraverseNegate);
	}
	...
	*/
	transient protected static BluePackTopoSorter topoSort = new BluePackTopoSorter();
	/**
	...
	*/
	...
	/**
	* Returns true iff. the last traverse was a negation.
	*/
	transient protected static boolean lastTraverseNegate = false;
